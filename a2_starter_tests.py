...
# ===========================sudoku_fail_fast_tests=============================

def test_sudoku_fail_fast() -> None:  # General
    """Test sudoku fail_fast."""
    ...
    s = SudokuPuzzle(4, [["A", "C", "D", "B"],  # General
                         ["D", "B", "A", "C"],
                         ["C", "A", " ", "D"],
                         [" ", " ", "B", "A"]],
                     {"A", "B", "C", "D"})
...
# ===========================sudoku_dfs_solver_tests============================

def test_sudoku_dfs_solver() -> None:
    """Test DFS on sudokus."""
    s = SudokuPuzzle(9,
                     [[" ", " ", " ", "9", " ", "2", " ", " ", " "],
                      [" ", "9", "1", " ", " ", " ", "6", "3", " "],
    ...
    solver = DfsSolver()
    lst = solver.solve(s)
    assert lst[-1].is_solved()


def test_dfs_solver_sudoku_similarities() -> None:
    ...
    sol2 = solver.solve(s, {str(sol[-1])})
    solutions.append(sol2[-1])

    expected = SudokuPuzzle(4, [["D", "C", "B", "A"],
                                ["B", "A", "D", "C"],
                                ["C", "D", "A", "B"],
                                ["A", "B", "C", "D"]],
                            {"A", "B", "C", "D"})
